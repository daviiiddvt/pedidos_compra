...
_LineaPedido _$LineaPedidoFromJson(Map<String, dynamic> json) => _LineaPedido(
  ...
  cantidadServida: (json['cantidadServida'] as num?)?.toDouble() ?? 0.0,
...
Map<String, dynamic> _$LineaPedidoToJson(_LineaPedido instance) =>
    <String, dynamic>{
      ...
      'cantidadServida': instance.cantidadServida,
...
_Pedido _$PedidoFromJson(Map<String, dynamic> json) => _Pedido(
  ...
  nDocumento: (json['n_doc'] as num?)?.toInt() ?? 0,
  serie: json['ser'] as String? ?? '',
  serieNombre: json['ser_nom'] as String? ?? '',
  comercial: json['cmr'] == null ? '' : _referenceToString(json['cmr']),
  comercialNombre: json['cmr_nom'] as String? ?? '',
  almacen: json['alm'] as String? ?? '',
  almacenNombre: json['alm_nom'] as String? ?? '',
  fecha: json['fch'] as String? ?? '',
  previstoPara: json['fch_ent'] as String? ?? '',
  formaPago: json['fpg'] as String? ?? '',
  formaPagoNombre: json['fpg_nom'] as String? ?? '',
  direccionEnvio: json['dir_env'] as String? ?? '',
  email: json['email'] as String? ?? '',
  observaciones: json['obs'] as String? ?? '',
);
...
Map<String, dynamic> _$PedidoToJson(_Pedido instance) => <String, dynamic>{
  ...
  'codigo': instance.codigo,
  'n_doc': instance.nDocumento,
  'ser': instance.serie,
  'ser_nom': instance.serieNombre,
  'cmr': _referenceToJson(instance.comercial),
  'cmr_nom': instance.comercialNombre,
  'alm': instance.almacen,
  'alm_nom': instance.almacenNombre,
  'fch': instance.fecha,
  'fch_ent': instance.previstoPara,
  'fpg': instance.formaPago,
  'fpg_nom': instance.formaPagoNombre,
  'dir_env': instance.direccionEnvio,
  'email': instance.email,
  'obs': instance.observaciones,
};

...
class _Pedido extends Pedido {
  const _Pedido({this.id, @JsonKey(name: 'num_ped') this.numeroPedido = '', @JsonKey(name: 'clt') this.clienteId = 0, @JsonKey(name: 'est') this.estado = 'P', @JsonKey(name: 'tot_ped') this.total = 0.0,  List<LineaPedido> lineas = const <LineaPedido>[], this.clienteNombre = '', this.clienteTelefono = '', this.clienteCif = '', this.cliente = '', this.codigo = 0, @JsonKey(name: 'n_doc') this.nDocumento = 0, @JsonKey(name: 'ser') this.serie = '', @JsonKey(name: 'ser_nom') this.serieNombre = '', @JsonKey(name: 'cmr', fromJson: _referenceToString, toJson: _referenceToJson) this.comercial = '', @JsonKey(name: 'cmr_nom') this.comercialNombre = '', @JsonKey(name: 'alm') this.almacen = '', @JsonKey(name: 'alm_nom') this.almacenNombre = '', @JsonKey(name: 'fch') this.fecha = '', @JsonKey(name: 'fch_ent') this.previstoPara = '', @JsonKey(name: 'fpg') this.formaPago = '', @JsonKey(name: 'fpg_nom') this.formaPagoNombre = '', @JsonKey(name: 'dir_env') this.direccionEnvio = '', @JsonKey(name: 'email') this.email = '', @JsonKey(name: 'obs') this.observaciones = ''}): _lineas = lineas,super._();
